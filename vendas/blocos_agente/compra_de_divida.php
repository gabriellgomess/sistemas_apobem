...
<div class="linha">
	<h3 class="mypets2">Compra de Dívida:</h3>
	<div class="thepet2">    	
		<table class="blocos" width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
					...
					<div class="scroller_calendar">
						<table class="listaValores" width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
							...
							<?php
								...
								if ($edicao == 1){
									echo "<a title='EXCLUIR COMPRA Nº: {$row_compras['compra_id']}' href='index.php?option=com_k2&view=item&id=182:excluir-divida&Itemid=123&tmpl=component&print=1&compra_id={$row_compras['compra_id']}&acao=exclui_divida' rel='lyteframe' rev='width: 550px; height: 400px; scroll:no;'><img src='sistema/imagens/delete.png'></a>";
									echo "<a title='EDITAR DÍVIDA Nº: {$row_compras['compra_id']}' href='index.php?option=com_k2&view=item&id=182:editar-divida&Itemid=123&tmpl=component&print=1&compra_id={$row_compras['compra_id']}&origem=edita_agente&acao=edita_divida' rel='lyteframe' rev='width: 650px; height: 500px; scroll:no;'><img src='sistema/imagens/edit.png'></a>";
								}
									echo "</div></td>";
									echo "</tr>";
			...
			<tr>
				...
				<td><div align="left"><strong><?php echo $total_saldos_label;?></strong></div></td>
