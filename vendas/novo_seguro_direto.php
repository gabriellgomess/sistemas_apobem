...
function removeCampo()
{
	...
	if(document.getElementById("add_btn").innerHTML == "" && cont<6)
	{
...
<form id="testform" action="index.php" method="GET">
					...
					<input name="layout" type="hidden" value="item" />
					<input name="id" type="hidden" value="64" />
					<input name="Itemid" type="hidden" value="485" />
...
<?php endif;?>		
	...
	<tr>
		<td>
			<div align="right"><label for="vendas_debito_banco">Telefones de Contato da Venda:</label></div>
		</td>
		<td>
		<div align="left">			
...
<?php
	...
	while($row_apolice = mysql_fetch_array( $result_apolice )) {
		if ($row_apolice["apolice_id"] == $_GET["vendas_apolice"]){$checked = " checked";}else{$checked = "";}
...
<?php if ($_GET["vendas_pgto"] == 1) :?>
	<tr>
		<td>
			<div align="right"><label for="vendas_debito_banco">Banco:</label></div>
		</td>
		<td>
		<div align="left">			
			<input type="text" name="vendas_debito_banco" value="<?php echo $row_cliente["cliente_banco"]; ?>" size="4" maxlength="4" onKeyPress="return SomenteNumero(event)"/>
		</div>
		</td>
	</tr>
	<tr>
		<td>
			<div align="right"><label for="vendas_debito_ag">Agência:</label></div>
		</td>
		<td>
		<div align="left">			
			<input type="text" name="vendas_debito_ag" value="<?php echo $row_cliente["cliente_agencia"]; ?>" size="8" maxlength="8"/>
		</div>
		</td>
	</tr>
	<tr>
		<td>
			<div align="right"><label for="vendas_debito_cc">Conta Corrente:</label></div>
		</td>
		<td>
		<div align="left">			
			<input type="text" name="vendas_debito_cc" value="<?php echo $row_cliente["cliente_conta"]; ?>" size="12" maxlength="12"/>
		</div>
		</td>
	</tr>
<?php elseif ($_GET["vendas_pgto"] == 2) :?>
	...
	<tr>
		...
		<td>
		<div align="left">			
			<input type="text" name="vendas_cartao_validade_mes" size="2" maxlength="2">(MM) 
			<input type="text" name="vendas_cartao_validade_ano" size="4" maxlength="4">(AAAA)
		</div>	
		</td>
	</tr>
	<tr>
...
<?php endif;?>
	<tr>
        <td colspan="2">
<h3 class="mypets">Beneficiário:</h3>
			<br />
