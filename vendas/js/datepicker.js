...
datePicker.months       = ["Janeiro","Fevereiro","Marco","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"];
datePicker.fullDay      = ["Segunda","Terca","Quarta","Quinta","Sexta","Sabado","Domingo"];
datePicker.titles       = ["Mes anterior","Mes seguinte","Ano antrior","Ano Seguinte", "Hoje", "Mostrar Calendario"];
