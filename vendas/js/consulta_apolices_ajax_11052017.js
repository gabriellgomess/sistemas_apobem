...
function consultaFormaPagamentoAjax() {
  ...
  xhttp.open("GET", "sistema/consultas_ajax/consulta_forma_pagamento_ajax.php?vendas_pgto="+vendas_pgto+"&clients_cpf="+clients_cpf, true);
  xhttp.send();
}
