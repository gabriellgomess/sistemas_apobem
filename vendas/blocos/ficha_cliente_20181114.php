<div class="thepet">
	...
	<div class="linha">
		...
		<div class="coluna campo-valor">
			...
			?> 
			<a href="<?php echo $link_cliente;?>"><strong><?php echo $row_client["cliente_nome"];?></strong></a>
	...
	<div class="linha">
		...
		<div class="coluna campo-valor">
            ...
            <?php else: ?>
            </br><strong><?php echo $row["vendas_orgao"];?></strong>
            <?php endif;?>
		</div>
	...
	<div class="linha">
		...
		<div class="coluna campo-valor"><?php echo $row_client["cliente_endereco"];?></div>
		<div class="coluna campo-titulo">Bairro:</div>
		<div class="coluna campo-valor"><?php echo $row_client["cliente_bairro"];?></div>
	</div>
	<div class="linha">
		<div class="coluna campo-titulo">Endereço de Entrega:</div>
		<div class="coluna campo-valor">
			<?php if ($row_client["cliente_endereco_entrega"]):?>
				<strong><?php echo $row_client["cliente_endereco_entrega"];?></strong>
				Nº: <strong><?php echo $row_client["cliente_numero"];?></strong>, Complemento:  <strong><?php echo $row_client["cliente_complemento"];?></strong>
			<?php else: ?>
				Não informado.
			<?php endif;?>
		</div>
