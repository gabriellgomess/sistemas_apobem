...
if ($_GET['token'] === 'EsearR31234fpssa0vfc9o') {
	...
	if ($erro) {
		...
		$nit = isset($respostaJson->payment->nit) ? $respostaJson->payment->nit : '';
		$sid = isset($respostaJson->schedule->sid) ? $respostaJson->schedule->sid : '';
		$status = isset($respostaJson->schedule->status) ? $respostaJson->schedule->status : '';
