...
var debito_dados = {    
    ...
    $(document).on("click", "#realizar_cobranca", function(){
        ...
        if( camposValidados )
        {
            ...
            xhttp.open("POST", "https://sistema.apobem.com.br/integracao/softwareexpress/transacao_individual/request_transacao_individual.php?token=EsearR31234fpssa0vfc9o", true);
            xhttp.send(formData);
        }
    });
