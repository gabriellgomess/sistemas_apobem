        ...
        <div class="linha">
                    ...
                    <div id="myDropdown" class="dropdown-content">
                        ...
                        <div class="wrapper-content">
                            ...
                            <div class="centralize">
                                <input id="telefone" type="text"><input type="checkbox" id="send-sms">
                            </div>
                            <label class="label-modal" for="email">Email</label>
                            <div class="centralize">
                                <input id="email" type="text"><input type="checkbox" id="send-email">
                            </div>
                        </div>
            ...
            function formatarTelefone($numero) {
                ...
                if (strlen($numero) === 11) {
                    ...
                    return $numero; // retorna sem formatação se for diferente
                }
            }
        ...
        <div class="linha">
            ...
            if (!empty($data)) {
                ...
                foreach ($data as $item) {
                    ...
                    echo '<td style="font-size: 12px">' . htmlspecialchars(formatarTelefone($item['telefone'])) . '</td>';
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        // Impede que caracteres como () sejam inseridos diretamente
        telefoneInput.addEventListener("keydown", function(e) {
            const key = e.key;
            // Permite backspace, delete, tab, seta etc
            if (
                key === "Backspace" ||
                key === "Delete" ||
                key === "ArrowLeft" ||
        ...
        jQuery('#send-btn').click(function() {
            ...
            var telefone = jQuery('#telefone').val().replace(/\D/g, '');
