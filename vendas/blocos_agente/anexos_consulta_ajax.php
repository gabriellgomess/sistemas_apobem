	...
	$result_anexos = mysql_query("SELECT *, DATE_FORMAT(anexo_data,'%d/%m/%Y') AS anexo_data 
	...
	<?php while($row_anexos = mysql_fetch_array( $result_anexos )): ?>
		...
		<div class="linha-exibe-lista" id="linha-<?php echo $numero; ?>"  style="background: <?php echo $cor_fundo; ?>; color: <?php echo $color; ?>" >
            ...
            <?php endif; ?>						
			<div class="coluna" style="width: 20%; text-align: center;"><span title="<?php echo $row_anexos['anexo_nome']; ?>"><a href="http://portal.grupofortune.com.br/portal/<?php echo $row_anexos['anexo_caminho']; ?>" target="_blank"><img width='32' height='32' src="<?php echo $anexo_icone; ?>"><br><?php echo substr($row_anexos['anexo_nome'],0,25); if(strlen($row_anexos['anexo_nome']) > 25) echo " ..."; ?></a></span></div>			
			<div class="coluna" style="width: 20%;"><span><?php echo $row_anexos['anexo_usuario']; ?></span><br><span><?php echo $row_anexos['anexo_data']; ?></span></div>
