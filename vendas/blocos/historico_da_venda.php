	...
	<div class="thepet2">
		...
		<?php
					...
					while($row_registros = mysql_fetch_array( $result_registros )) {
						...
						echo "<td width='20%'><div align='left'><span {$style}>";
						include("sistema/latin1.php");
						if($row_registros['registro_status']){
							...
							echo "<img src='sistema/imagens/status_{$row_registros['registro_status']}.png'> <br/>".$status;
						}
						if (($row['vendas_produto'] == 1)&&($row_registros['registro_contrato_fisico'])){
							include("sistema/utf8.php");
