...
$fp = fopen("/var/www/html/integracao/softwareexpress/atualizacao/logs/boletos/".$nome.".html", "a");
fwrite($fp, $saida);
fclose($fp);
...
if($num_rows == 0){
    $sql_insere_registro = "INSERT INTO `sys_historico_script_atualizacao` (`historico_nome`, `historico_data`, `historico_log`, `historico_cont_pagos`, `historico_total_pagos`, `historico_cont_naopagos`, `historico_total_naopagos`, `data`, `dia_semana`, `ambiente`) 
         VALUES ('".$nome.".html', '".$data_hora_atual."' , 'https://grupofortune.com.br/integracao/softwareexpress/atualizacao/logs/boletos/".$nome.".html', ".$contPagos.", ".$totalPagos.", ".$contVencidos.", ".$totalVencidos.", '".$data_atual."', '".$dia_semana."' ,'".$ambiente."')";
